...
This is the initial language specification for the Malice language defined by the Imperial Department of Computing. 
...
We are also using \texttt{ALPHA} and \texttt{DIGIT} from Augmented Backus-Naur Form (ABNF). \texttt{ALPHA} represents the letters A--Z and a--z and \texttt{DIGIT} represents the digits 0--9. This allows our specification to be more succinct and easier to read.
