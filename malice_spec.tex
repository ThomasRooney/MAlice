...
The example programs provided have not specified any syntax which we could interpret to be calling functions. However, we assume that this could be done by adding our own syntax, specified with the following BNF productions:
