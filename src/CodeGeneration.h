...
namespace MAlice {
    ...
    namespace CodeGeneration {
        ...
        bool generateCodeForFunctionProcedureNode(ASTNode paramsNode, ASTNode bodyNode, FunctionProcedureEntity *funcProcEntity, llvm::Value **outValue, ASTWalker *walker, CompilerContext *ctx);
    }
}
